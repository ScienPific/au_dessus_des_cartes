...
const CountryInfo = (country) => {
    ...
    if (country.country === "none") {
        ...
        return (
            <div id="country_content" className="content-main-page">
                <div className="section-main-page">
                    <h1>France</h1>
                    <p className="paragraph-main-page">
                    ...
                    Mauris eget pellentesque tellus. Etiam ut mauris tempus, rutrum elit non, luctus magna. Nulla facilisi. Sed eget viverra nulla. Integer eget viverra massa. Nunc luctus sed leo a malesuada. Fusce molestie, neque quis congue mattis, sapien nisi tincidunt ipsum, ac accumsan velit lacus et sapien. Nullam eu ante et neque posuere lobortis. Nunc nisl dolor, mattis ut mi quis, pharetra facilisis ligula. Vestibulum volutpat, lectus quis malesuada pharetra, mauris velit pharetra turpis, ac tincidunt orci quam a purus. Maecenas mollis ac tortor at dapibus. Nam mauris sem, laoreet sit amet pulvinar id, euismod at arcu. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae;
                </p></div>
                
                <div className="shape-fun-fact"> <p> Premier pays à légaliser la cocaïne</p></div>
                <div className="grid-container">
                    <div className="grid-item">
                        <img src="https://www.editionsdanielderveaux.fr/WebRoot/epagesFR/Shops/30e1dd72-9483-11e3-9284-000d609a287c/5373/3C46/FB49/E264/029D/0A0C/05E0/BD0D/GB_Histoire_de_France.jpg" className="image-fr"></img>
                    </div>
                    <div className="grid-item">
                        <img src="https://www.editionsdanielderveaux.fr/WebRoot/epagesFR/Shops/30e1dd72-9483-11e3-9284-000d609a287c/5373/3C46/FB49/E264/029D/0A0C/05E0/BD0D/GB_Histoire_de_France.jpg"className="image-fr"></img>
                    </div>
